 ...
 */
WARN_UNUSED_RESULT bool psbt_get_serial_id(struct wally_unknowns_map *map, u16 *serial_id);
 ...
 *
 * Note that diff is based on *serial_ids*. All inputs+outputs
 * MUST have a serial_id field present before calling this.
 *
 ...
 * @orig - original psbt
 * @new - updated psbt
 * @added_ins - inputs added to {new}
 * @rm_ins - inputs removed from {new}
