...
/* Generated stub for new_json_stream */
struct json_stream *new_json_stream(const tal_t *ctx UNNEEDED, struct command *writer UNNEEDED,
				    struct logger *log UNNEEDED)
{ fprintf(stderr, "new_json_stream called!\n"); abort(); }
