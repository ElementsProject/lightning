...
{
	CHECK(memeq(&i1->funding_txid,
		    sizeof(struct sha256_double),
		    &i2->funding_txid,
		    sizeof(struct sha256_double)));
	CHECK(i1->funding_outnum == i2->funding_outnum);
	CHECK(i1->funding_feerate == i2->funding_feerate);
	CHECK(amount_sat_eq(i1->funding, i2->funding));
	CHECK(amount_sat_eq(i1->our_funds, i2->our_funds));
