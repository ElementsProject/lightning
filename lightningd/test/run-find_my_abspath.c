...
/* Generated stub for zeroconf_options_new */
struct zeroconf_options *zeroconf_options_new(const tal_t *ctx UNNEEDED)
{ fprintf(stderr, "zeroconf_options_new called!\n"); abort(); }
