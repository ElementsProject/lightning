...
/* Generated stub for towire_onchaind_watch_outpoints */
u8 *towire_onchaind_watch_outpoints(const tal_t *ctx UNNEEDED, const struct bitcoin_txid *txid UNNEEDED, u32 blockheight UNNEEDED, const struct bitcoin_outpoint *outpoints UNNEEDED)
{ fprintf(stderr, "towire_onchaind_watch_outpoints called!\n"); abort(); }
