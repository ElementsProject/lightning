...
def generate_wait_examples(l1, l2, bitcoind, executor):
    ...
    try:
        ...
        sync_blockheight(bitcoind, [l2])
        wbhres = wbh.result(5)
        update_example(node=l2, method='waitblockheight', params={'blockheight': curr_blockheight + 1, 'timeout': 600}, res=wbhres, execute=False, description=[f'This will return after the next block is mined because requested waitblockheight is one block higher than the current blockheight.'])
        REPLACE_RESPONSE_VALUES.extend([
...
def generate_askrene_examples(l1, l2, l3, c12, c23_2):
    ...
    try:
        ...
        update_example(node=l1, method='askrene-listreservations', params={}, res=askrene_listreservations_res1, execute=False)
        ...
        REPLACE_RESPONSE_VALUES.extend([
            {'data_keys': ['short_channel_id_dir'], 'original_value': scid12dir, 'new_value': f"{NEW_VALUES_LIST['c12']}/{direction12}"},
        ...
        def list_missing_examples():
            ...
            try:
                ...
                for file_name in os.listdir('doc/schemas'):
                    ...
                    if file_name_str not in ALL_METHOD_NAMES and file_name_str not in IGNORE_RPCS_LIST:
