...
def generate_askrene_examples(l1, l2, l3, c12, c23_2):
    ...
    try:
        ...
        update_example(node=l2, method='askrene-bias-node', params={'layer': 'test_layers', 'node': l3.info["id"], 'bias': 1})
        update_example(node=l2, method='askrene-bias-node', params=['test_layers', l3.info["id"], -5, 'this node is unreliable'])
