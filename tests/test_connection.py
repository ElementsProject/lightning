...
def test_fundee_forget_funding_tx_unconfirmed(node_factory, bitcoind):
    ...
    assert [c['state'] for c in l2.rpc.listpeerchannels()['channels']] == ['CHANNELD_AWAITING_LOCKIN', 'CHANNELD_AWAITING_LOCKIN']
    ...
    assert [c['state'] for c in l2.rpc.listpeerchannels()['channels']] == ['CHANNELD_AWAITING_LOCKIN']
    assert l2.rpc.listpeerchannels(l1.info['id']) == {'channels': []}
