...
def test_setconfig(node_factory, bitcoind):
    ...
    with open(setconfigfile, 'r') as f:
        ...
        assert lines == ["# Created and update by setconfig, but you can edit this manually", "min-capacity-sat=500000"]
    ...
    with open(setconfigfile, 'r') as f:
        lines = f.read().splitlines()
        assert lines == ["# Created and update by setconfig, but you can edit this manually", "min-capacity-sat=400000"]
