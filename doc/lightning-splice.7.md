...
**splice** *script\_or\_json* [*dryrun*] [*force\_feerate*] [*debug\_log*] [*dev-wetrun*] 
...
- **script\_or\_json** (string): The splice script to execute or json equivilent
...
- **debug\_log** (boolean, optional): Adds a verbose log of each splice calculation step to the result
