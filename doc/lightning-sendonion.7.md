...
**sendonion** *onion* *first\_hop* *payment\_hash* [*label*] [*shared\_secrets*] [*partid*] [*bolt11*] [*amount\_msat*] [*destination*] [*localinvreqid*] [*groupid*] [*description*] 
...
the error details are decrypted and presented here, if *shared\_secrets* was provided and an error was returned by one of the intermediate nodes
