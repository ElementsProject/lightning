...
Lightning daemon configuration file
...
**log-file**=*PATH*  
Log to this file instead of stdout. Sending lightningd(1) SIGHUP will
...
for existing channels, use the RPC call lightningd-setchannelfee(7).
...
**commit-fee-min**=*PERCENT*; **commit-fee-max**=*PERCENT*  
