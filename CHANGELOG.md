...
### Fixed
 ...
 - lightningd: stay connected when we send an error for an unknown channel_reestablish, fixing the reestablish reconnect loop ([#9427])

[#9427]: https://github.com/ElementsProject/lightning/pull/9427
