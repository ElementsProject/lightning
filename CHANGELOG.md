...
### Added
 ...
 - lightningd: `setchannel` can upgrade a private channel to public by setting `announce` to true ([#9428])

[#9428]: https://github.com/ElementsProject/lightning/pull/9428
