...
### Changed
 ...
 - plugins: the `sql` plugin now stores short_channel_id as integers; use `scid('1x2x3')` in queries instead of string literals (breaking change for string comparisons) ([#9430])

[#9430]: https://github.com/ElementsProject/lightning/pull/9430
