			...
			const char *base58, size_t base58_len)
{
	...
	size_t written = 0;
	int r = wally_base58_to_bytes(base58, BASE58_FLAG_CHECKSUM, buf, buflen, &written);
		     ...
		     bool *test_net, struct privkey *priv, struct pubkey *key)
{
	...
	size_t written = 0;
	int r = wally_base58_to_bytes(base58, BASE58_FLAG_CHECKSUM, keybuf, keybuflen, &written);
