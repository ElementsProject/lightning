...
pub mod requests {
	...
	/// status of the payment we wish to delete
	#[derive(Copy, Clone, Debug, Deserialize, Serialize)]
	...
	#[derive(Clone, Debug, Deserialize, Serialize)]
	pub struct MultiwithdrawOutputs {
	}

	#[derive(Clone, Debug, Deserialize, Serialize)]
	pub struct MultiwithdrawRequest {
	    #[serde(alias = "outputs")]
	    pub outputs: Vec<MultiwithdrawOutputs>,
	    #[serde(alias = "feerate", skip_serializing_if = "Option::is_none")]
	    pub feerate: Option<Feerate>,
	    #[serde(alias = "minconf", skip_serializing_if = "Option::is_none")]
	    pub minconf: Option<u32>,
	    #[serde(alias = "utxos", skip_serializing_if = "Option::is_none")]
	    pub utxos: Option<Outpoint>,
	}
	...
	pub struct ListconfigsRequest {
	    #[serde(alias = "config", skip_serializing_if = "Option::is_none")]
...
pub mod responses {
	...
	#[derive(Clone, Debug, Deserialize, Serialize)]
	pub struct DecodePathsPath {
	    #[serde(alias = "node_id")]
	    pub node_id: Pubkey,
	    #[serde(alias = "encrypted_recipient_data")]
	    pub encrypted_recipient_data: String,
	}

	#[derive(Clone, Debug, Deserialize, Serialize)]
	pub struct DecodePaths {
	    #[serde(alias = "blinding")]
	    pub blinding: Pubkey,
	    #[serde(alias = "path")]
	    pub path: Vec<DecodePathsPath>,
	}

	#[derive(Clone, Debug, Deserialize, Serialize)]
	pub struct DecodeRecurrencePaywindow {
	    #[serde(alias = "seconds_before")]
	    pub seconds_before: u32,
	    #[serde(alias = "seconds_after")]
	    pub seconds_after: u32,
	    #[serde(alias = "proportional_amount", skip_serializing_if = "Option::is_none")]
	    pub proportional_amount: Option<bool>,
	}

	#[derive(Clone, Debug, Deserialize, Serialize)]
	pub struct DecodeRecurrence {
	    #[serde(alias = "time_unit")]
	    pub time_unit: u32,
	    #[serde(alias = "time_unit_name", skip_serializing_if = "Option::is_none")]
	    pub time_unit_name: Option<String>,
	    #[serde(alias = "period")]
	    pub period: u32,
	    #[serde(alias = "basetime", skip_serializing_if = "Option::is_none")]
	    pub basetime: Option<u64>,
	    #[serde(alias = "start_any_period", skip_serializing_if = "Option::is_none")]
	...
	pub struct DecodeResponse {
	    ...
	    #[serde(alias = "offer_id", skip_serializing_if = "Option::is_none")]
	    pub offer_id: Option<String>,
	    #[serde(alias = "chains", skip_serializing_if = "Option::is_none")]
	    pub chains: Option<Vec<String>>,
	    #[serde(alias = "currency", skip_serializing_if = "Option::is_none")]
	    pub currency: Option<String>,
	    #[serde(alias = "minor_unit", skip_serializing_if = "Option::is_none")]
	    pub minor_unit: Option<u32>,
	    #[serde(alias = "warning_offer_unknown_currency", skip_serializing_if = "Option::is_none")]
	    pub warning_offer_unknown_currency: Option<String>,
	    #[serde(alias = "amount", skip_serializing_if = "Option::is_none")]
	    pub amount: Option<u64>,
	    #[serde(alias = "amount_msat", skip_serializing_if = "Option::is_none")]
	    pub amount_msat: Option<Amount>,
	    #[serde(alias = "send_invoice", skip_serializing_if = "Option::is_none")]
	    pub send_invoice: Option<bool>,
	    #[serde(alias = "refund_for", skip_serializing_if = "Option::is_none")]
	    ...
	    #[serde(alias = "features", skip_serializing_if = "Option::is_none")]
	    pub features: Option<String>,
	    #[serde(alias = "absolute_expiry", skip_serializing_if = "Option::is_none")]
	    pub absolute_expiry: Option<u64>,
	    #[serde(alias = "paths", skip_serializing_if = "Option::is_none")]
	    pub paths: Option<Vec<DecodePaths>>,
	    #[serde(alias = "quantity_min", skip_serializing_if = "Option::is_none")]
	    pub quantity_min: Option<u64>,
	    #[serde(alias = "quantity_max", skip_serializing_if = "Option::is_none")]
	    pub quantity_max: Option<u64>,
	    #[serde(alias = "warning_offer_missing_description", skip_serializing_if = "Option::is_none")]
	    pub warning_offer_missing_description: Option<String>,
	    #[serde(alias = "chain", skip_serializing_if = "Option::is_none")]
	    pub chain: Option<String>,
	    #[serde(alias = "quantity", skip_serializing_if = "Option::is_none")]
	    pub quantity: Option<u64>,
	    #[serde(alias = "recurrence_counter", skip_serializing_if = "Option::is_none")]
	    pub recurrence_counter: Option<u32>,
	    #[serde(alias = "recurrence_start", skip_serializing_if = "Option::is_none")]
	    pub recurrence_start: Option<u32>,
	    #[serde(alias = "recurrence_basetime", skip_serializing_if = "Option::is_none")]
	    pub recurrence_basetime: Option<u32>,
	    #[serde(alias = "payer_info", skip_serializing_if = "Option::is_none")]
	    pub payer_info: Option<String>,
	    #[serde(alias = "created_at", skip_serializing_if = "Option::is_none")]
	    pub created_at: Option<u64>,
	    #[serde(alias = "payment_hash", skip_serializing_if = "Option::is_none")]
	    pub payment_hash: Option<String>,
	    #[serde(alias = "relative_expiry", skip_serializing_if = "Option::is_none")]
	    pub relative_expiry: Option<u32>,
	    #[serde(alias = "min_final_cltv_expiry", skip_serializing_if = "Option::is_none")]
	    pub min_final_cltv_expiry: Option<u32>,
	    #[serde(alias = "fallbacks", skip_serializing_if = "Option::is_none")]
	    pub fallbacks: Option<Vec<DecodeFallbacks>>,
	    #[serde(alias = "warning_invoice_missing_amount", skip_serializing_if = "Option::is_none")]
	    pub warning_invoice_missing_amount: Option<String>,
	    #[serde(alias = "warning_invoice_missing_description", skip_serializing_if = "Option::is_none")]
	    pub warning_invoice_missing_description: Option<String>,
	    #[serde(alias = "warning_invoice_missing_blinded_payinfo", skip_serializing_if = "Option::is_none")]
	    pub warning_invoice_missing_blinded_payinfo: Option<String>,
	    #[serde(alias = "warning_invoice_invalid_blinded_payinfo", skip_serializing_if = "Option::is_none")]
	    pub warning_invoice_invalid_blinded_payinfo: Option<String>,
	    #[serde(alias = "warning_invoice_missing_recurrence_basetime", skip_serializing_if = "Option::is_none")]
	    pub warning_invoice_missing_recurrence_basetime: Option<String>,
	    #[serde(alias = "warning_invoice_missing_created_at", skip_serializing_if = "Option::is_none")]
	    pub warning_invoice_missing_created_at: Option<String>,
	    #[serde(alias = "warning_invoice_missing_payment_hash", skip_serializing_if = "Option::is_none")]
	    pub warning_invoice_missing_payment_hash: Option<String>,
	    #[serde(alias = "warning_invoice_refund_signature_missing_payer_key", skip_serializing_if = "Option::is_none")]
	    pub warning_invoice_refund_signature_missing_payer_key: Option<String>,
	    #[serde(alias = "warning_invoice_refund_signature_invalid", skip_serializing_if = "Option::is_none")]
	    pub warning_invoice_refund_signature_invalid: Option<String>,
	    #[serde(alias = "warning_invoice_refund_missing_signature", skip_serializing_if = "Option::is_none")]
	    pub warning_invoice_refund_missing_signature: Option<String>,
	    #[serde(alias = "warning_invoice_request_missing_offer_id", skip_serializing_if = "Option::is_none")]
	    pub warning_invoice_request_missing_offer_id: Option<String>,
	    #[serde(alias = "warning_invoice_request_missing_payer_key", skip_serializing_if = "Option::is_none")]
	    pub warning_invoice_request_missing_payer_key: Option<String>,
	    #[serde(alias = "warning_invoice_request_missing_recurrence_signature", skip_serializing_if = "Option::is_none")]
	    pub warning_invoice_request_missing_recurrence_signature: Option<String>,
	    #[serde(alias = "warning_invoice_request_invalid_recurrence_signature", skip_serializing_if = "Option::is_none")]
	    pub warning_invoice_request_invalid_recurrence_signature: Option<String>,
	    #[serde(alias = "expiry", skip_serializing_if = "Option::is_none")]
	    pub expiry: Option<u64>,
	    #[serde(alias = "payee", skip_serializing_if = "Option::is_none")]
	    pub payee: Option<Pubkey>,
	    #[serde(alias = "description_hash", skip_serializing_if = "Option::is_none")]
	    pub description_hash: Option<String>,
	    #[serde(alias = "payment_secret", skip_serializing_if = "Option::is_none")]
	    pub payment_secret: Option<String>,
	    #[serde(alias = "payment_metadata", skip_serializing_if = "Option::is_none")]
	    pub payment_metadata: Option<String>,
	    #[serde(alias = "routes", skip_serializing_if = "Option::is_none")]
	    pub routes: Option<Vec<Vec<DecodeRoutes>>>,
	    #[serde(alias = "extra", skip_serializing_if = "Option::is_none")]
	...
	pub struct ListconfigsResponse {
	    #[serde(alias = "# version", skip_serializing_if = "Option::is_none")]
	    pub  version: Option<String>,
	    #[serde(alias = "plugins", skip_serializing_if = "Option::is_none")]
	    pub plugins: Option<Vec<ListconfigsPlugins>>,
	    #[serde(alias = "important_plugins", skip_serializing_if = "Option::is_none")]
	    pub important_plugins: Option<Vec<ListconfigsImportantPlugins>>,
	    #[serde(alias = "conf", skip_serializing_if = "Option::is_none")]
	    pub conf: Option<String>,
	    #[serde(alias = "lightning-dir", skip_serializing_if = "Option::is_none")]
	    pub lightning_dir: Option<String>,
	    #[serde(alias = "network", skip_serializing_if = "Option::is_none")]
	    pub network: Option<String>,
	    #[serde(alias = "allow-deprecated-apis", skip_serializing_if = "Option::is_none")]
	    pub allow_deprecated_apis: Option<bool>,
	    #[serde(alias = "rpc-file", skip_serializing_if = "Option::is_none")]
	    pub rpc_file: Option<String>,
	    #[serde(alias = "disable_plugin", skip_serializing_if = "Option::is_none")]
	    pub disable_plugin: Option<Vec<String>>,
	    #[serde(alias = "always-use-proxy", skip_serializing_if = "Option::is_none")]
	    pub always_use_proxy: Option<bool>,
	    #[serde(alias = "daemon", skip_serializing_if = "Option::is_none")]
	    pub daemon: Option<bool>,
	    #[serde(alias = "wallet", skip_serializing_if = "Option::is_none")]
	    pub wallet: Option<String>,
	    #[serde(alias = "large-channels", skip_serializing_if = "Option::is_none")]
	    pub large_channels: Option<bool>,
	    #[serde(alias = "experimental-dual-fund", skip_serializing_if = "Option::is_none")]
	    pub experimental_dual_fund: Option<bool>,
	    #[serde(alias = "experimental-onion-messages", skip_serializing_if = "Option::is_none")]
	    pub experimental_onion_messages: Option<bool>,
	    #[serde(alias = "experimental-offers", skip_serializing_if = "Option::is_none")]
	    pub experimental_offers: Option<bool>,
	    #[serde(alias = "experimental-shutdown-wrong-funding", skip_serializing_if = "Option::is_none")]
	    pub experimental_shutdown_wrong_funding: Option<bool>,
	    #[serde(alias = "experimental-websocket-port", skip_serializing_if = "Option::is_none")]
	    pub experimental_websocket_port: Option<u16>,
	    #[serde(alias = "rgb", skip_serializing_if = "Option::is_none")]
	    pub rgb: Option<String>,
	    #[serde(alias = "alias", skip_serializing_if = "Option::is_none")]
	    pub alias: Option<String>,
	    #[serde(alias = "pid-file", skip_serializing_if = "Option::is_none")]
	    pub pid_file: Option<String>,
	    #[serde(alias = "ignore-fee-limits", skip_serializing_if = "Option::is_none")]
	    pub ignore_fee_limits: Option<bool>,
	    #[serde(alias = "watchtime-blocks", skip_serializing_if = "Option::is_none")]
	    pub watchtime_blocks: Option<u32>,
	    #[serde(alias = "max-locktime-blocks", skip_serializing_if = "Option::is_none")]
	    pub max_locktime_blocks: Option<u32>,
	    #[serde(alias = "funding-confirms", skip_serializing_if = "Option::is_none")]
	    pub funding_confirms: Option<u32>,
	    #[serde(alias = "cltv-delta", skip_serializing_if = "Option::is_none")]
	    pub cltv_delta: Option<u32>,
	    #[serde(alias = "cltv-final", skip_serializing_if = "Option::is_none")]
	    pub cltv_final: Option<u32>,
	    #[serde(alias = "commit-time", skip_serializing_if = "Option::is_none")]
	    pub commit_time: Option<u32>,
	    #[serde(alias = "fee-base", skip_serializing_if = "Option::is_none")]
	    pub fee_base: Option<u32>,
	    #[serde(alias = "rescan", skip_serializing_if = "Option::is_none")]
	    pub rescan: Option<i64>,
	    #[serde(alias = "fee-per-satoshi", skip_serializing_if = "Option::is_none")]
	    pub fee_per_satoshi: Option<u32>,
	    #[serde(alias = "max-concurrent-htlcs", skip_serializing_if = "Option::is_none")]
	    pub max_concurrent_htlcs: Option<u32>,
	    #[serde(alias = "htlc-minimum-msat", skip_serializing_if = "Option::is_none")]
	    pub htlc_minimum_msat: Option<Amount>,
	    #[serde(alias = "htlc-maximum-msat", skip_serializing_if = "Option::is_none")]
	    pub htlc_maximum_msat: Option<Amount>,
	    #[serde(alias = "max-dust-htlc-exposure-msat", skip_serializing_if = "Option::is_none")]
	    pub max_dust_htlc_exposure_msat: Option<Amount>,
	    #[serde(alias = "min-capacity-sat", skip_serializing_if = "Option::is_none")]
	    pub min_capacity_sat: Option<u64>,
	    #[serde(alias = "addr", skip_serializing_if = "Option::is_none")]
	    pub addr: Option<String>,
	    #[serde(alias = "announce-addr", skip_serializing_if = "Option::is_none")]
	    pub announce_addr: Option<String>,
	    #[serde(alias = "bind-addr", skip_serializing_if = "Option::is_none")]
	    pub bind_addr: Option<String>,
	    #[serde(alias = "offline", skip_serializing_if = "Option::is_none")]
	    pub offline: Option<bool>,
	    #[serde(alias = "autolisten", skip_serializing_if = "Option::is_none")]
	    pub autolisten: Option<bool>,
	    #[serde(alias = "proxy", skip_serializing_if = "Option::is_none")]
	    pub proxy: Option<String>,
	    #[serde(alias = "disable-dns", skip_serializing_if = "Option::is_none")]
	    pub disable_dns: Option<bool>,
	    #[serde(alias = "disable-ip-discovery", skip_serializing_if = "Option::is_none")]
	    pub disable_ip_discovery: Option<bool>,
	    #[serde(alias = "encrypted-hsm", skip_serializing_if = "Option::is_none")]
	    pub encrypted_hsm: Option<bool>,
	    #[serde(alias = "rpc-file-mode", skip_serializing_if = "Option::is_none")]
	    pub rpc_file_mode: Option<String>,
	    #[serde(alias = "log-level", skip_serializing_if = "Option::is_none")]
	    pub log_level: Option<String>,
	    #[serde(alias = "log-prefix", skip_serializing_if = "Option::is_none")]
	    pub log_prefix: Option<String>,
	    #[serde(alias = "log-file", skip_serializing_if = "Option::is_none")]
	    pub log_file: Option<String>,
	    #[serde(alias = "log-timestamps", skip_serializing_if = "Option::is_none")]
	    pub log_timestamps: Option<bool>,
	    #[serde(alias = "force-feerates", skip_serializing_if = "Option::is_none")]
	    pub force_feerates: Option<String>,
	    #[serde(alias = "subdaemon", skip_serializing_if = "Option::is_none")]
	    pub subdaemon: Option<String>,
	    #[serde(alias = "fetchinvoice-noconnect", skip_serializing_if = "Option::is_none")]
	    pub fetchinvoice_noconnect: Option<bool>,
	    #[serde(alias = "tor-service-password", skip_serializing_if = "Option::is_none")]
