...
use cln_rpc::{ClnRpc, model::responses::XpayResponse, notifications::LogLevel};
...
pub enum RecklessCmd {
    /// Install a plugin, start it and then persist to config
    Install(InstallArgs),

    /// Stop a plugin and remove it from configs and disk
...
impl InstallResponse {
    pub fn new(result: InstallResult, logger: RecklessLogger) -> InstallResponse {
        InstallResponse {
            install: result,
            log: logger.log,
        }
...
pub struct UpdateResponse {
    update: Vec<InstallResult>,
    log: Vec<String>,
}
impl UpdateResponse {
    pub fn new(result: Vec<InstallResult>, logger: RecklessLogger) -> UpdateResponse {
        UpdateResponse {
            update: result,
            log: logger.log,
        }
...
pub struct UninstallResponse {
    uninstall: CommonResult,
    log: Vec<String>,
}
impl UninstallResponse {
    pub fn new(result: CommonResult, logger: RecklessLogger) -> UninstallResponse {
        UninstallResponse {
            uninstall: result,
            log: logger.log,
        }
...
impl EnableResponse {
    pub fn new(result: CommonResult, logger: RecklessLogger) -> EnableResponse {
        EnableResponse {
            enable: result,
            log: logger.log,
        }
...
pub struct DisableResponse {
    disable: CommonResult,
    log: Vec<String>,
}
impl DisableResponse {
    pub fn new(result: CommonResult, logger: RecklessLogger) -> DisableResponse {
        DisableResponse {
            disable: result,
            log: logger.log,
        }
...
#[derive(Debug, Serialize)]
pub struct ListavailableResponse {
    listavailable: Vec<ListavailableResult>,
    log: Vec<String>,
}
impl ListavailableResponse {
    pub fn new(result: Vec<ListavailableResult>, logger: RecklessLogger) -> ListavailableResponse {
...
#[derive(Debug, Serialize)]
pub struct ListavailableResult {
    plugin_name: String,
    origin: PluginOrigin,
    installer: Installer,
    manifest: RecklessManifest,
}
impl From<RecklessPlugin> for ListavailableResult {
    fn from(plugin: RecklessPlugin) -> Self {
        ListavailableResult {
...
pub struct ListinstalledResponse {
    listinstalled: Vec<ListinstalledResult>,
    log: Vec<String>,
}
impl ListinstalledResponse {
    pub fn new(result: Vec<ListinstalledResult>, logger: RecklessLogger) -> ListinstalledResponse {
        ListinstalledResponse {
            listinstalled: result,
            log: logger.log,
        }
    }
}
...
impl ListinstalledResult {
    pub fn new(metadata: Metadata, plugin_name: String) -> ListinstalledResult {
        ListinstalledResult {
            plugin_name,
            installation_date: metadata.installation_date,
            installation_time: metadata.installation_time,
            original_source: metadata.original_source,
            requested_commit: metadata.requested_commit,
...
pub struct SourcesResponse {
    sources: Vec<PluginOrigin>,
    log: Vec<String>,
}
impl SourcesResponse {
    pub fn new(result: Vec<PluginOrigin>, logger: RecklessLogger) -> SourcesResponse {
        SourcesResponse {
            sources: result,
            log: logger.log,
        }
...
impl TipResponse {
    pub fn new(result: XpayResponse, logger: RecklessLogger) -> TipResponse {
        TipResponse {
            tip: result,
            log: logger.log,
        }
