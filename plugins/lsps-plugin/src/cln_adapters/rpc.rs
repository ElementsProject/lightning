...
fn jit_channel_reserve(zero_reserve: bool) -> Option<AmountSat> {
    zero_reserve.then(|| AmountSat::from_sat(0))
}
...
mod tests {
    ...
    fn jit_channel_reserve_defaults_to_lightningd() {
        ...
        assert_eq!(jit_channel_reserve(true), Some(AmountSat::from_sat(0)));
    }
}
